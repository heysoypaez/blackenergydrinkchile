  ...
  1.  **Setup Contentful Models**
      ...
      ```
      contentful space --space-id 1us0mfst32lg import --content-file oneshopper.json


      contentful space  import --content-file oneshopper.json


      contentful space  export --content-file oneshopper.json
